      ...
      >
        ...
        <template #column-1>
          <div class="form-content">
            <h2 id="beta-form" class="section-title">{{ t('form_data.title_feedback') }}</h2>
            <FormGrid
              :fields="formFields" 
              :maxColumns=2
              :submitButton="{ 
...
<script setup>
  ...
  import ContentUS from '@/content/us/ContentAppLingoFeedback.vue'
  import ContentRU from '@/content/ru/ContentAppLingoFeedback.vue'
